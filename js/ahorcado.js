...
var listaPalabras = ["desafio", "juego", "algoritmo", "alura", "oracle", "codigo", "declaracion",
    "challenge", "funcion", "variable", "operacion", "metodo", "constante", "parametro", "lenguaje",
    "javascript", "html", "web", "programacion", "prueba"];
...
function gameOver() {
    if(document.querySelector(".state-nodisplay") != null){
        ...
        over.textContent = "INTENTA NUEVAMENTE";
...
function drawGame() {
    ...
    if (window.modoOscuro == false) {
        pincel.strokeStyle = rs.getPropertyValue('--color7');
    }
    else {
...
function youWin() {
    if(document.querySelector(".state-nodisplay") != null){
        ...
        you.textContent = "FELICITACIONES";
